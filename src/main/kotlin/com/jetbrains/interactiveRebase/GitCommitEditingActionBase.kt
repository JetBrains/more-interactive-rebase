...
abstract class GitCommitEditingActionBase<T : GitCommitEditingActionBase.MultipleCommitEditingData> : DumbAwareAction() {
    ...
    override fun update(e: AnActionEvent) {
        ...
        if (commitEditingDataCreationResult is CommitEditingDataCreationResult.Prohibited) {
        ...
        val commitEditingData = (commitEditingDataCreationResult as CommitEditingDataCreationResult.Created<T>).data
    ...
    final override fun actionPerformed(e: AnActionEvent) {
        val commitEditingRequirements = (createCommitEditingData(e) as CommitEditingDataCreationResult.Created<T>).data
