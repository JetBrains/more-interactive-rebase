...
class IRTestGitImpl : GitImpl() {
    private val log = Logger.getInstance(IRTestGitImpl::class.java)
    ...
    class InteractiveRebaseEditor(
        val entriesEditor: ((String) -> String)?,
    ...
    override fun createRebaseEditor(
        project: Project,
        root: VirtualFile,
        handler: GitLineHandler,
        commitListAware: Boolean,
        ...
        val editor =
            object : GitInteractiveRebaseEditorHandler(project, root) {
    ...
    private fun failOrCallRebase(
        repository: GitRepository,
        delegate: () -> GitRebaseCommandResult,
    ): GitRebaseCommandResult {
